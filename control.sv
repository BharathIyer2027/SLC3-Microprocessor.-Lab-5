...
module control (
    ...
    output logic addr_1_select,
    output logic [1:0] addr_2_select,
    output logic sr1_select,
    output logic dr_select,
    output logic sr2_mux_select,
    output logic [1:0] ALUK,
    output logic [3:0] gate_select,
    output logic ld_cc);
	...
	begin 
		...
		case (state)
			...
			s_18 : 
				begin 
				    gate_select = 4'b1000; //gatePC
					ld_mar = 1'b1;
					ld_pc = 1'b1;
					pc_select = 2'b00;  // pc+1
			...
			s_35 : 
				begin 
			         gate_select = 4'b0010;//MDR
					ld_ir = 1'b1;
				end
			s_1 : 
			 begin
			     ld_reg = 1'b1; 
			     sr1_select = 1'b1; // ir[8:6]
			     sr2_mux_select = ir[5]; //immediate or 2nd register
			     dr_select = 1'b0; // ir[11:9]
			     ld_cc = 1'b1;
			     gate_select = 4'b0001; //gate ALU
			     ALUK = 2'b00; // Add
			     end
			 s_5: 
			 begin
